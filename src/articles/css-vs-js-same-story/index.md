...
🤝 Выбрать комплексный подход для проблем, затрагивающих JS, HTML и CSS (загрузка ресурсов, сборка, изоляция и др.) и улучшить коммуникацию между организациями по стандартизации ([@TC39](https://twitter.com/TC39), [@csswg](https://twitter.com/csswg), [@WHATWG](https://twitter.com/WHATWG), [@wicg\_](https://twitter.com/wicg_), [@w3c](https://twitter.com/w3c), и т. д.) Может быть через [@w3ctag](https://twitter.com/w3ctag)?
